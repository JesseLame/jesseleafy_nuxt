import { ref, defineComponent, withAsyncContext, computed, watchEffect, unref, mergeProps, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(recipe)) {
        ...
        if (unref(descriptionLongHTML)) {
          _push(`<div class="text-gray-700 mb-6 prose">${unref(descriptionLongHTML) ?? ""}</div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=_slug_-Clekl42L.js.map
