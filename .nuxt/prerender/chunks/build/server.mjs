import { computed, toValue, getCurrentInstance, onServerPrefetch, hasInjectionContext, inject, ref, shallowRef, toRef, nextTick, unref, defineAsyncComponent, defineComponent, h, provide, shallowReactive, Suspense, Fragment, createElementBlock, cloneVNode, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, withAsyncContext, withCtx, getCurrentScope, useSSRContext } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/radix3/dist/index.mjs';
import defu$1, { defu } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withoutTrailingSlash } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/vue/server-renderer/index.mjs';
import { parse } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/date-fns/index.js';
import { debounce } from 'file:///Users/jesselamerigts/WebDev/jesseleafy_nuxt/node_modules/perfect-debounce/dist/index.mjs';
...
const _routes = [
  {
    name: "list",
    path: "/list",
    component: () => import('./list-BoywwCjx.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-bFnSwLcz.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CxTMtO4A.mjs')
  },
  {
    name: "testPage",
    path: "/testPage",
    component: () => import('./testPage-DxQly3Ti.mjs')
  },
  {
    name: "recipes",
    path: "/recipes",
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-0tMcUiC0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-B0Hq70pZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BTHG43zd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C2_01sFM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-CeTWhM9w.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DZje9SFZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Bn8ozzn0.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data: recentRecipes } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("recentRecipes", async () => {
      const allRecipes = await queryCollection("recipes").all();
      [...new Set(
        allRecipes.map((r) => r.categories).flat().filter((c) => c && c !== "uncategorized")
      )];
      [...new Set(
        allRecipes.map((r) => r.tags).flat().filter((t) => t && t !== "uncategorized")
      )];
      const recentRecipes2 = allRecipes.filter((r) => r.created).map((r) => ({
        ...r,
        _createdParsed: parse(r.created, "dd-MM-yyyy", /* @__PURE__ */ new Date())
      })).filter((r) => !isNaN(r._createdParsed)).sort((a, b) => b._createdParsed - a._createdParsed).slice(0, 6);
      console.log("allRecipes:", allRecipes);
      console.log("recentRecipes:", recentRecipes2);
      return recentRecipes2;
